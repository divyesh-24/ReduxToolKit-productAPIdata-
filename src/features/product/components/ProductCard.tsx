  ...
  return (
    ...
    >
      <CardActionArea sx={{ minHeight: '100%' }}>
        <div
          className="md:max-w-sm flex flex-col justify-between sm:mx-0 relative bg-inherit p-6   rounded-xl shadow-lg 
        "
        >
          {/* transform lg:hover:scale-105 transition duration-500 pt-6 pb-2*/}
          ...
          {product.inStock ? (
            <CardActions>
              <Button
                ...
                sx={{ paddingY: '8px', marginTop: '16px' }}
              >
                ADD TO CART
              </Button>
            </CardActions>
